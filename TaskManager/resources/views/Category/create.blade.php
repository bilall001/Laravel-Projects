                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="name" name="name" id="name" class="form-control" placeholder="Enter category name" required>
                            </div>
                        </div>
                        <!-- Description -->
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="slug" id="slug" class="form-control" rows="5" placeholder="slug details"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="description">Description</label>
                                <textarea name="description" id="description" class="form-control" rows="5" placeholder=" details"></textarea>
                            </div>
                        </div>
                    </div>
                </div>							
    ...
    $(document).ready(function () {
        ...
        let countdownInterval = setInterval(function () {
            ...
            if (seconds <= 0) {
                ...
                window.location.href = "{{ route('category.index') }}"; // Change route if needed
            }
        }, 1000);
    });
</script>
