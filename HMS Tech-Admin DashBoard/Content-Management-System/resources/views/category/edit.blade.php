        ...
        <div class="card-body">
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="slug" name="slug" class="form-control" placeholder="Enter category slug" value="{{ old('slug', $category->slug) }}">
                </div>

                <div class="form-group mb-3">
                    <label for="description">Description (Optional)</label>
                    <input type="text" id="description" name="description" class="form-control" placeholder="Enter category description" value="{{ old('description', $category->description) }}">
                </div>
